...
public class StringRedisHelper {
	 ...
	 */
	public List<MapRecord<String, Object, Object>> subscribeStream(org.springframework.data.redis.connection.stream.Consumer consumer, StreamReadOptions readOptions, StreamOffset<String>... streams){
	 ...
	 * @see <a href="https://redis.io/commands/xread">Redis Documentation: XREAD</a>
	 */
	public <V> List<ObjectRecord<String, V>> subscribeStream(Class<V> targetType, org.springframework.data.redis.connection.stream.Consumer consumer, StreamReadOptions readOptions, StreamOffset<String>... streams) {
