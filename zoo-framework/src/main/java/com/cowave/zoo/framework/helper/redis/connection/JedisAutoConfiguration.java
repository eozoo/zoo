...
public class JedisAutoConfiguration {
    ...
    @Bean
    public JedisRedisConnectionConfiguration zooRedisConnectionConfiguration(Environment environment,
            ObjectProvider<RedisSentinelConfiguration> sentinelConfiguration,
            ObjectProvider<RedisClusterConfiguration> clusterConfiguration){
    ...
    @Bean
    public JedisConnectionFactory zooRedisConnectionFactory(
            @Qualifier("zooRedisConnectionConfiguration") JedisRedisConnectionConfiguration redisConnectionConfiguration,
            ObjectProvider<JedisClientConfigurationBuilderCustomizer> builderCustomizers){
        return redisConnectionConfiguration.redisConnectionFactory(builderCustomizers);
    }
}
